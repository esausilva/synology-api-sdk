...
public class GetRawResponseAsyncNotSuccessfulTests
{
    ...
    [Test]
    [DependsOn(nameof(Assert_GetAsync_Response_Is_NotNull))]
    public async Task Assert_GetAsync_HttpResponse_Is_Null()
    {
        await Assert
    ...
    [Test]
    [DependsOn(nameof(Assert_GetAsync_Response_Is_NotNull))]
    public async Task Assert_GetAsync_Response_Has_ErrorResponse()
    {
        await Assert
            .That(_result!.Error)
            .IsNotNull();
