...
public class FotoTeamBrowseItemRequestTests : RequestTestsBase
{
    ...
    public static void Setup_Request()
    {
        ...
        var requestBase = new FotoTeamBrowseItemRequest(
            version: 2,
            method: "list",
    ...
    public async Task Assert_Api_QueryParam_Is_Mapped()
    {
        await Assert
            .That(_url)
            .Contains($"api={SynologyApis.FotoTeam.BrowseItem}");
    }
    ...
    [Test]
    public async Task Assert_FolderId_QueryParam_Is_Mapped()
    {
        await Assert
            .That(_url)
            .Contains("folder_id=123");
    }
    ...
    public async Task Assert_Request_Throws_Exception_When_SynoToken_Is_Null()
    {
        await Assert
            .That(() =>
            {
                _ = new FotoTeamBrowseItemRequest(
                    version: 2,
                    method: "list",
                    synoToken: null!,
                    offset: 0,
    ...
    [Test]
    public async Task Assert_Request_Throws_Exception_When_FolderId_Is_Negative()
    {
        await Assert
            .That(() =>
            {
